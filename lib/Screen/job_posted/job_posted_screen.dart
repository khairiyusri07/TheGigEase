...
import 'widgets/gigs.dart';
import 'widgets/transporter.dart';
...
class _CategorySelector extends State<CategorySelector> {
  List<String> categories = ['Gigs jobs', 'Transporter jobs',];
  List<String> screenTitles = ['Gigs jobs', 'Transporter jobs',];
